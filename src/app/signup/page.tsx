...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Success - redirect to login (or directly to dashboard)
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`h-14 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all duration-300 ${
                  ...
                  >
                    ...
                    <span className={`text-[12px] font-medium font-[family-name:var(--font-body)] ${
                      formData.userType === type.value ? "text-[var(--primary-accent)]" : "text-[var(--text-muted)]"
                    }`}>
                      {type.label}
                    </span>
                  </button>
